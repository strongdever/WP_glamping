jQuery(function($) {
    ...
    function foodAdd() {
        pageContent = `
            <div class="page-content">
                ...
                <table class="admin-editor">
                    <tr><th>フードタイプ(英)</th><td><input type="text" name="english[]" value=""></td></tr>
                    <tr><th>フードタイプ(和)</th><td><input type="text" name="japanese[]" value=""></td></tr>
        ...
        $('.food-remove').on('click', foodRemove);
    }
